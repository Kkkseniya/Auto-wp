...
add_action( 'wp_enqueue_scripts', function(){
  ...
  //отключаем jquery, уже идущий с WP, и регистриуем свой jquery
...
// ============================== SVG-files ==============================
//В WP по умолчанию нельзя загружать svg-файлы, но если очень надо, то есть способы. Здесь используем один из них
