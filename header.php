  ...
  <header class="header">
    <div class="container">
      <div class="header__top">
        ...
        <?php the_custom_logo(); ?>
        <a class="phone" href="tel:<?php the_field('simple-phone'); ?>"><?php the_field('phone'); ?></a>
      </div>
