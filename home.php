  ...
  <section class="services">
    <div class="container">
      ...
      <div class="services__inner">
        ...
        <!-- <div class="services__content-box"> was cut -->
        <?php the_field('service-text'); ?>
        </div>
        <!-- <ol class="services__list"> was cut -->
    ...
    <div class="container">
      <div class="benefits__inner">
        ...
        <div class="benefits__content">
          ...
          <!-- <ul class="benefits__list"> was cut -->
    ...
    <div class="container">
      <div class="contacts__inner">
        <div class="contacts__info">
          ...
          <ul class="contacts__list">
            ...
            <li class="contacts__item">
              ...
              <p class="contacts__item-text">
              <a href="tel:<?php the_field('simple-phone'); ?>"><?php the_field('phone'); ?></a>
              </p>
            </li>
          </ul>
        </div>
        <form class="contacts__form">
          ...
          <!-- place fo form (2 inputs and 1 button) -->
